...
# Send to Extension
You can manually create buttons if you like in other decks or just create a template deck with just only starting predictions. **We strongly advise only to **


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjcwMjY1NCw3NTQyNTM1NzAsMzE3MT
