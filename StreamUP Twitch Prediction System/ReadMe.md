...
# Send to Extension
You can manually create buttons if you like in other decks or just create a template deck with just only starting predictions. **We strongly advise only to create 'StreamUP - Set Prediction' buttons**


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk0MzYwMzk2NCw3NTQyNTM1NzAsMzE3MT
